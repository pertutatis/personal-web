...
| --- | --- | --- |
| Team | Tener Definidos 3/3 career plans  | Setear 4 sesiones con cada uno de los directs para trabajar en el career plan (framework de radical candor [Link]) |
| Delivery cycle | Cumplir un 80% del trabajo comprometido en cada sprint | 1 Optimizar dailies a máximo 15 minutos para el XX/XX/2022. 2 implementar conclusiones del análisis del delivery, reducir bottle necks para el XX/XX/2022. 3 Promover asincronía en las tareas en Jira. 4 Documentar el delivery cycle para el XX/XX/2022. 5 Ver si necesitamos cambiar a kanban |
| Outcome |  tener un framework en el team para que todo el equipo tenga visibilidad del outcome de forma activa | 1 Definir funnel de métricas para el XX/XX/2022. 2 Sacar dashboards de control para el XX/XX/2022. 3 Propuesta de NSM y proxy metrics para el XX/XX/2022. 4 Documentarlo para el XX/XX/2022. 5 Presentarlo al team para el XX/XX/2022. |
| Roadmap | tener un roadmap a 6 meses | 1 Empezar a guardar pains y posibles oportunidades. 2 Juntarse con product para ver next opportunities.3 Empezar a mover los DD de estas oportunidades. 4 En cuanto tengamos clara nuestra NSM, priorizar y crear el roadmap. 5 Definir objetivos. Ver estacionalidad comparando años anteriores, intentar sacar un patrón para ver si podemos maximizar revenue detectando los puntos de más tráfico. |
