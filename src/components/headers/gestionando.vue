<template>
  <div class="article-header">
    <div class="article-header__container">
      <!-- Estrellas -->
      <div class="stars">
        <div v-for="n in 10" :key="n" class="star"></div>
      </div>
      ...
      <div class="space-station">
        ...
        <div class="station-modules">
          <div v-for="n in 4" :key="n" class="module"></div>
        </div>
      </div>

      <!-- Flota de naves -->
      <div class="fleet">
        <div v-for="n in 3" :key="n" class="ship"></div>
      </div>

      <!-- Meteoros -->
      <div class="meteors">
        <div v-for="n in 3" :key="n" class="meteor"></div>
      </div>
      ...
      <div class="energy-particles">
        <div v-for="n in 5" :key="n" class="energy-particle"></div>
      </div>
...
.nebula {
  ...
  background: radial-gradient(
    circle,
    rgba(255, 79, 79, 0.3) 0%,
    rgba(255, 159, 67, 0.2) 40%,
    transparent 80%
  );
  border-radius: 50%;
  top: -150px;
