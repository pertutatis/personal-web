...
// Crear estrellas animadas
            ...
            const observer = new IntersectionObserver((entries) => {
                entries.forEach(entry => {
                    if (entry.isIntersecting) {
                        (entry.target as HTMLElement).style.animation = 'slideIn 0.8s ease-out forwards';
                    }
                });
            }, { threshold: 0.1 });
        ...
        window.addEventListener('scroll', () => {
            ...
            if (nebula1 && nebula2) {
                nebula1.style.transform = `translateY(${scrolled * 0.5}px) rotate(${scrolled * 0.1}deg)`;
                nebula2.style.transform = `translateY(${-scrolled * 0.3}px) rotate(${-scrolled * 0.1}deg)`;
            }
        });
        ...
        window.addEventListener('scroll', () => {
            particleCount++;
            if (particleCount % 10 === 0) { // Crear partícula cada 10 scrolls
        ...
        function activateHyperdrive() {
            ...
            for (let i = 0; i < 50; i++) {
                setTimeout(() => {
                    ...
                    line.style.background = 'linear-gradient(180deg, transparent, #74b9ff, transparent)';
  ...
  <div class="satellites">
    ...
    <main>
        <div class="container">
            <!-- Header del CV -->
            <div class="cv-header">
                <h1 class="cv-title">Trayectoria Profesional</h1>
                <p class="cv-subtitle">Un viaje a través del cosmos del Engineering Management</p>
            </div>
                ...
                <div class="timeline">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <div class="job-period">Marzo 2022 - Presente</div>
                            <h3 class="job-title">Engineering Manager</h3>
                            <p class="company">Seedtag</p>
                            <div class="job-description">
                                <p>Lidero el equipo de ingeniería en la línea de negocio Ad exchange / open marketplace de Seedtag, trabajando en la fase de scale-up del vertical.</p>
                                ...
                                <ul>
                                    <li><strong>Team Scaling:</strong> Expandí de 5 a 20 miembros, gestionando el proceso de hiring completo</li>
                                    <li><strong>Crecimiento Anual:</strong> Logré un incremento anual del 70% al 100% de 2022 a 2024</li>
                                    <li><strong>Engineering Management:</strong> Gestión directa e indirecta de 16 ingenieros</li>
                                    <li><strong>Mejora del Delivery:</strong> Reduje el cycle time en un 66%</li>
                                    <li><strong>Desarrollo del Equipo:</strong> Conseguí dos promociones y dos cambios de rol en el último año</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        <div class="timeline-node"></div>
                        <div class="timeline-content">
                            <div class="job-period">Marzo 2020 - Marzo 2022</div>
                            <h3 class="job-title">Engineering Team Lead</h3>
                            <p class="company">Jeffapp</p>
                            <div class="job-description">
                                <p>Engineering Team Lead en el squad de Internal Users y posteriormente en los nuevos squads de Services Entrepreneurs y Laundry Entrepreneurs.</p>
                                <ul>
                    ...
                    <div class="timeline-item">
                        <div class="timeline-node"></div>
                        <div class="timeline-content">
                            <div class="job-period">Diciembre 2019 - Febrero 2020</div>
                            <h3 class="job-title">Senior Frontend Product Engineer</h3>
                            <p class="company">Jeffapp</p>
                            <div class="job-description">
                                <p>Desarrollo del Backoffice platform que sirve como herramienta interna para dar soporte a nuestros franquiciados.</p>
                                <ul>
                                    <li>Definir e implementar la arquitectura frontend con aplicaciones Vue en contenedores docker</li>
                                    <li>Responsable de asegurar la implementación de un design system en el back office</li>
                    ...
                    <div class="timeline-item">
                        <div class="timeline-node"></div>
                        <div class="timeline-content">
                            <div class="job-period">Enero 2017 - Octubre 2019</div>
                            <h3 class="job-title">Technical Consultant</h3>
                            <p class="company">The Serious & The Influence Mafia</p>
                            <div class="job-description">
                                <p>Consultoría en nuevas tecnologías y procesos digitales para múltiples clientes.</p>
                                <ul>
                                ...
                                <div style="margin-top: 1rem;">
                                    <strong>Clientes:</strong> Generalitat Valenciana, Natural de montaña, Sofffood, Nación Sushi, Vayoil Textil, Smattex
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        <div class="timeline-node"></div>
                        <div class="timeline-content">
                            <div class="job-period">Septiembre 2017 - Septiembre 2019</div>
                            <h3 class="job-title">Senior Frontend and Product Developer</h3>
                            <p class="company">WAM We Are Marketing</p>
                            <div class="job-description">
                                <p>Desarrollo de productos para creación de landings y páginas web basadas en drag & drop.</p>
                                <ul>
                                    <li>Desarrollo de producto para crear landings y páginas web basado en drag & drop</li>
            ...
            <div class="sidebar">
                ...
                <ul class="contact-info">
                    <li>
                        ...
                        <span>diegopertusa@gmail.com</span>
                    </li>
                    <li>
                        <div class="contact-icon">🔗</div>
                ...
                <div class="skills-section">
                    <div class="skill-category">
                        ...
                        <div class="skills-list">
                            ...
                            <span class="skill-tag">Gestión equipos</span>
                            <span class="skill-tag">Comunicación</span>
                            <span class="skill-tag">Radical Candor</span>
                            <span class="skill-tag">Transparencia</span>
                            <span class="skill-tag">Ownership</span>
                        </div>
                    </div>
                    ...
                    <div class="skill-category">
                        <h4>🌐 Idiomas</h4>
                        <div class="skills-list">
                            <span class="skill-tag">Español</span>
                    ...
                    <div class="skill-category">
                        <h4>🎓 Formación</h4>
                        <div class="skills-list">
                            <span class="skill-tag">IGNITE Program</span>
                            <span class="skill-tag">ID3 Postgraduate</span>
                            <span class="skill-tag">Ing. Diseño UPV</span>
                        </div>
                    </div>
                </div>
            </div>
...
.nebula1 {
  width: 600px;
  height: 600px;
  background: radial-gradient(circle, rgba(116, 185, 255, 0.1) 0%, rgba(162, 155, 254, 0.05) 30%, transparent 70%);
  top: -200px;
  right: -200px;
...
.nebula2 {
  width: 500px;
  height: 500px;
  background: radial-gradient(circle, rgba(253, 121, 168, 0.08) 0%, rgba(255, 127, 71, 0.04) 40%, transparent 80%);
  bottom: -150px;
  left: -150px;
...
.cv-title {
  ...
  font-weight: 700;
  background: linear-gradient(135deg, var(--cv-accent-color) 0%, var(--cv-accent-2-color) 50%, var(--cv-accent-3-color) 100%);
...
.timeline::before {
  ...
  bottom: 0;
  width: 2px;
  background: linear-gradient(180deg, var(--cv-accent-color), var(--cv-accent-2-color), var(--cv-accent-3-color));
  transform: translateX(-50%);
  animation: timelineGlow 3s infinite alternate;
}

@keyframes timelineGlow {
  0% { box-shadow: 0 0 10px var(--cv-accent-color); }
  100% { box-shadow: 0 0 20px var(--cv-accent-2-color); }
}
...
.timeline-node {
  ...
  width: 20px;
  height: 20px;
  background: linear-gradient(135deg, var(--cv-accent-color), var(--cv-accent-2-color));
  border-radius: 50%;
  transform: translateX(-50%);
  z-index: 10;
...
.timeline-content::before {
  ...
  width: 30px;
  height: 2px;
  background: linear-gradient(90deg, var(--cv-accent-color), var(--cv-accent-2-color));
...
::-webkit-scrollbar-thumb {
  background: linear-gradient(180deg, var(--cv-accent-color), var(--cv-accent-2-color));
  border-radius: 4px;
}

::-webkit-scrollbar-thumb:hover {
  background: linear-gradient(180deg, var(--cv-accent-2-color), var(--cv-accent-3-color));
}
</style>
